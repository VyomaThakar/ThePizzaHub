...
<head>
    ...
    <style>
        ...
        * {
        ...
        .slide-2{
          background:url('https://images.unsplash.com/photo-1699891730669-2d15cf3a5979?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHx0b3BpYy1mZWVkfDE4fGlVSXNuVnRqQjBZfHxlbnwwfHx8fHw%3D');
          background-size:cover;
          background-position:center;
          background-repeat:no-repeat;
        }
        .slide-3{
          background:url('./french\ fries.png');
          background-size:cover;
          background-position:center;
          background-repeat:no-repeat;
        }

...
<body>
    ...
    <div class="login-card">
        ...
        <asp:TextBox ID="unm"  class="input" runat="server" placeholder="Registered Number"></asp:TextBox>
        <asp:TextBox ID="pass" class="input" runat="server" placeholder="Password"></asp:TextBox>

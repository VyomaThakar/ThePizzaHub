<%@ Page Language="C#" AutoEventWireup="true" CodeFile="juice.aspx.cs" MasterPageFile="~/user/user.master" Inherits="user_juice" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:mycon %>" SelectCommand="SELECT * FROM [food]"></asp:SqlDataSource>
    <html xmlns="http://www.w3.org/1999/xhtml">
        <body>
            <div>
                <h1 style="margin-bottom:20px; margin-top:20px; color:#fa5f55;" align="center">Juice</h1>

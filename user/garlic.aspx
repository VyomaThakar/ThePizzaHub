<%@ Page Language="C#" AutoEventWireup="true" CodeFile="garlic.aspx.cs"  MasterPageFile="~/user/user.master" Inherits="user_garlic" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <html xmlns="http://www.w3.org/1999/xhtml">
        <body>
            <div>
                <h1 style="margin-bottom:20px; margin-top:20px; color:#fa5f55;" align="center">Garlic Bread</h1>
